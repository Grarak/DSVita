...
pub const PRESENTER_SUB_RESIZED_2_5X_SCREEN_WIDTH_BOT:  u32 = PRESENTER_SCREEN_WIDTH - PRESENTER_SUB_RESIZED_2_5X_SCREEN_WIDTH_TOP - GAP;
...
pub const PRESENTER_SUB_RESIZED_2_5X_BOTTOM_SCREEN: PresenterScreen = PresenterScreen::new(
    PRESENTER_SUB_RESIZED_2_5X_SCREEN_WIDTH_TOP + GAP,
