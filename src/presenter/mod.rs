...
const SUB_OFFSET: u32 = 8;
pub const PRESENTER_SUB_RESIZED_2_5X_SCREEN_WIDTH_TOP:  u32 = DISPLAY_WIDTH  as u32 * 5 / 2;
pub const PRESENTER_SUB_RESIZED_2_5X_SCREEN_HEIGHT_TOP: u32 = DISPLAY_HEIGHT as u32 * 5 / 2;
pub const PRESENTER_SUB_RESIZED_2_5X_SCREEN_WIDTH_BOT:  u32 = PRESENTER_SCREEN_WIDTH - PRESENTER_SUB_RESIZED_2_5X_SCREEN_WIDTH_TOP - SUB_OFFSET;
pub const PRESENTER_SUB_RESIZED_2_5X_SCREEN_HEIGHT_BOT: u32 = PRESENTER_SUB_RESIZED_2_5X_SCREEN_WIDTH_BOT * 3 / 4;
pub const PRESENTER_SUB_RESIZED_2_5X_TOP_SCREEN: PresenterScreen = PresenterScreen::new(
    0,
    (PRESENTER_SCREEN_HEIGHT - PRESENTER_SUB_RESIZED_2_5X_SCREEN_HEIGHT_TOP) / 2,
    PRESENTER_SUB_RESIZED_2_5X_SCREEN_WIDTH_TOP,
    PRESENTER_SUB_RESIZED_2_5X_SCREEN_HEIGHT_TOP,
);
pub const PRESENTER_SUB_RESIZED_2_5X_BOTTOM_SCREEN: PresenterScreen = PresenterScreen::new(
    PRESENTER_SUB_RESIZED_2_5X_SCREEN_WIDTH_TOP + SUB_OFFSET,
    (PRESENTER_SCREEN_HEIGHT - PRESENTER_SUB_RESIZED_2_5X_SCREEN_HEIGHT_BOT) / 2,
    PRESENTER_SUB_RESIZED_2_5X_SCREEN_WIDTH_BOT,
    PRESENTER_SUB_RESIZED_2_5X_SCREEN_HEIGHT_BOT,
);
...
pub const PRESENTER_SUB_RESIZED_2_5X: ScreenTopology = ScreenTopology {
    top: PRESENTER_SUB_RESIZED_2_5X_TOP_SCREEN,
    bottom: PRESENTER_SUB_RESIZED_2_5X_BOTTOM_SCREEN,
    mode: ScreenMode::Resized_2_5X,
};