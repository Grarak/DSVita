...
pub const TOTAL_MEM_SIZE: u32 = 16 * 1024 /* Some padding for mmu */
        ...
        + MMU_PAGE_SIZE as u32 /* Palettes */
        + MMU_PAGE_SIZE as u32 /* OAM */
        + vram::TOTAL_SIZE as u32
        + MMU_PAGE_SIZE as u32 /* GBA ROM/RAM, filled with 0xFF */
        + MMU_PAGE_SIZE as u32 /* Both BIOSES, filled with 0x0 */
;
...
const P_VRAM_OFFSET: usize = P_PALETTES_OFFSET + MMU_PAGE_SIZE;
const P_OAM_OFFSET: usize = P_VRAM_OFFSET + vram::TOTAL_SIZE;
const P_GBA_ROM_OFFSET: usize = P_OAM_OFFSET + MMU_PAGE_SIZE;
const P_ARM9_BIOS_OFFSET: usize = P_GBA_ROM_OFFSET + MMU_PAGE_SIZE;
...
pub const PALETTES_REGION: MemRegion = MemRegion::new(STANDARD_PALETTES_OFFSET as usize, VRAM_OFFSET as usize, MMU_PAGE_SIZE, P_PALETTES_OFFSET, true);
...
pub const OAM_REGION: MemRegion = MemRegion::new(OAM_OFFSET as usize, GBA_ROM_OFFSET as usize, MMU_PAGE_SIZE, P_OAM_OFFSET, true);
...
pub const ARM9_BIOS_REGION: MemRegion = MemRegion::new(0x0F000000, 0x10000000, MMU_PAGE_SIZE, P_ARM9_BIOS_OFFSET, false);
pub const ARM7_BIOS_REGION: MemRegion = MemRegion::new(ARM7_BIOS_OFFSET as usize, MAIN_OFFSET as usize, MMU_PAGE_SIZE, P_ARM7_BIOS_OFFSET, false);
