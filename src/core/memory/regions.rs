...
pub const TOTAL_MEM_SIZE: u32 = ITCM_SIZE + DTCM_SIZE + MAIN_SIZE + SHARED_WRAM_SIZE + ARM7_WRAM_SIZE + WIFI_RAM_SIZE
        + PAGE_SIZE as u32 /* GBA ROM, filled with 0xFF */
        + PAGE_SIZE as u32 /* Both BIOSES, filled with 0x0 */;
...
const P_ARM9_BIOS_OFFSET: usize = P_GBA_ROM_OFFSET + PAGE_SIZE;
...
pub const GBA_ROM_REGION: MemRegion = MemRegion::new(GBA_ROM_OFFSET as usize, GBA_RAM_OFFSET as usize, PAGE_SIZE, P_GBA_ROM_OFFSET, false);
pub const ARM9_BIOS_REGION: MemRegion = MemRegion::new(0xF0000000, 0x10000000, PAGE_SIZE, P_ARM9_BIOS_OFFSET, false);
pub const ARM7_BIOS_REGION: MemRegion = MemRegion::new(ARM7_BIOS_OFFSET as usize, MAIN_OFFSET as usize, PAGE_SIZE, P_ARM7_BIOS_OFFSET, false);
