    ...
    pub fn write<T: Convert>(&mut self, addr_offset: u32, value: T, hle: &mut Hle) {
        ...
        while (index - 3) < bytes.len() {
            io_ports_write!(match addr_offset + (index - 3) as u32 {
                ...
                io32(0x5C0) => common.gpu.gpu_3d.set_box_test(mask, value),
                io32(0x5C4) => common.gpu.gpu_3d.set_pos_test(mask, value),
                io32(0x5C8) => common.gpu.gpu_3d.set_vec_test(mask, value),
